                                    ...
                                    <div class="tabla_borde">
                                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size:19px">N° {{$sale->id}} </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size:14px">Fecha de registro: {{$sale->date}} </span>
                                                    </td>
                                                </tr>
                                        ...
                                        <table width="100%" height="0" border="0" border-radius="" cellpadding="9" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <strong>Observacion: </strong>{{$sale->reason}}
                                                    </td>
                                                </tr>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                ...
                                ?>
                                        <tr class="border_top">
                                            ...
                                            <td align="left">
                                                {{$d->stock->product->name}}
                                            </td>
                                            <td align="left">
                                                {{$d->stock->product->category->name}}
                                            </td>
                                            <td align="left">
                                                {{$d->amount}}
                                            </td>
                                   ...
                                   ?>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td align="left" class="bold" > TOTAL </td>
                                        <td align="left" class="bold" > {{$sale->total}} </td>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td align="left" class="bold">Total de Venta: {{$sale->total}}</td>
                                        <td align="left" class="bold">Recibido: {{$sale->pay}} </td>
                                        <td align="left" class="bold">Cambio: {{$sale->exchange}}</td>
